...
import { destroyProfile, indexProfiles, profileLifecycle, profileLifecycleEvents, showProfile, storeProfile, updateProfileController } from '../controllers/profiles.controller.js'
...
profilesRouter.get('/:id/lifecycle-events', profileLifecycleEvents)
